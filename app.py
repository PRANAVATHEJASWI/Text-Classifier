...
def classifier():
    ...
    st.markdown("""
        ...
        .st-emotion-cache-15hul6a, .st-emotion-cache-qgch5, .e1nzilvr5 {
            color: white !important;
        }
        .css-1q6v1bq button:hover, .css-1q6v1bq button:active {
            background-color: #0056b3;
        }
        .css-18e3th9 {
            background-color: skyblue;
        }
        #text-classification-app, #home, #welcome {
            color: #83B4FF;
        }
        .marks {
    ...
    if choice == "Home":
        ...
        st.markdown("""
            This app allows you to classify text into different categories using machine learning.
            """)
